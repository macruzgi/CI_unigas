        ...
        $("#cuentabancos").RSV({
            ...
            rules: [
                ...
                //"required,codigo, Debe ingesar el código del proveedor.",
						...
						"required,numerochequeori,Debe haber seleccionado un cheque.",
						"required,idchequeori,Debe seleccionar un cheque"
            ]
        });
    });
...
<legend class = legend1>Modificar Cheque</legend>

        <form method="POST" id="cuentabancos" class="wufoo" action="<?php echo base_url();?>micontrolador/ActualizarCheque/" name = "cuentabancos">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
				...
				<li>
                    ...
                    <div>
                      <select name = cuenta id="cuenta" onchange ='ponerIdCuentaCotnableCexbox(this.value)'>
					   <option value ="<?php echo $listarDatosChequeAmodificar[0]->id_cuenta_bancaria;?>"><?php echo $listarDatosChequeAmodificar[0]->nombre_banco_cuenta." - ".$listarDatosChequeAmodificar[0]->numero_cuenta_bancaria;?></option>
			...
			<td>
				  <!--TODOS ESTOS SERAN HIDDEN (OCULTOS) PARA ENVIARLOS A LA ACTION DEL FORM-->
			      <?php
					if($estado == true)
								{
				  ?> 
				   <input type ="hidden" name = "otroidcheque" size ="25" id ="otroidcheque" value="<?php echo $listarDatosChequeAmodificarChequeDos[0]->id_cheque;?>" readOnly>
			       <?php
								}
					else
						{
				   ...
				   ?>
									   <input type ="hidden" name = "otroidcheque" size ="25" id ="otroidcheque" value="0" readOnly>
					<?php
						}
					?>
				   <input type ="hidden" name = "numerochequeori" size ="25" id ="numerochequeori" value="<?php echo $listarDatosChequeAmodificar[0]->numero_cheque;?>" readOnly>
					<input name="idchequeori" type="hidden" size = 60  id="idchequeori" value="<?php echo $listarDatosChequeAmodificar[0]->id_cheque;?>" maxlength="255" readOnly />
					<!--fin de los ocultos-->
					<li>
						<?php
							...
							if($estado == true)
								{
						?>
							<label class="desc"><span class="req">Cuenta bancaria a la cual se transfirieron los fondos:</span></label>
							<div>
								<?php
									echo $listarDatosChequeAmodificarChequeDos[0]->nombre_banco_cuenta." - ".$listarDatosChequeAmodificarChequeDos[0]->numero_cuenta_bancaria;
								}
							else
								{
								?>
        ...
        <td width = "50%">
           ...
           <li>
            ...
            <label class="desc">A nombre de:<span class="req">*</span></label>
                    <div>
                        <input name="anombrede" type="text" size = 60  id="anombrede" value="<?php echo $listarDatosChequeAmodificar[0]->a_nombre_de;?>" maxlength="255"/>
                    </div>
            </li>
				...
				<td>
					...
					<label class="desc">Transferencia entre cuentas:</label>
						...
						<input name="tranferenciaentrecuentas" type="checkbox" id="tranferenciaentrecuentas" onclick="mostrarLaOtraCuentaBancariaAtransferir();" value ="<?php echo $listarDatosChequeAmodificar[0]->id_cuenta_bancaria;?>">
      ...
      <tr>
         <td  width =15%>
                      ...
                      <div>
                          <input name="monto" type="text" class="field text medium" id="nomto" value="<?php echo $listarDatosChequeAmodificar[0]->monto_cheque;?>" maxlength="255"/>
                      </div>
                  </li>
          </td> 
           <td>
          ...
          <td>
                    ...
                    <div>
                     <input name="fecha" type="text" size =10  id="fecha" value = "<?php echo $listarDatosChequeAmodificar[0]->fecha_emision;?>" maxlength="255"/>
                    </div> 
            </li> 
				</td>
        ...
        <td colspan = 2 align = center>
                    ...
                    <div>
                          <textarea class="catalogo"  rows="5" cols="60" name = "concepto" id = "concepto"><?php echo $listarDatosChequeAmodificar[0]->concepto_cheque;?>
						  </textarea>
                    </div>
                </li>
				    </td>
