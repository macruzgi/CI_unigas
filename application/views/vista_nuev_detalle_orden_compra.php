...
//PARA MOSTRAR LOS DATOS DE LA SESION
			if(isset($_SESSION["carro"]) || is_array($_SESSION["carro"])) {
			   $productosEnElCarro= $_SESSION["carro"];
							}
...
$.ajax({
type: "POST",
url: "<?php echo base_url();?>micontrolador/InteractivoProductos/" + idCompra + "/" + idCodigoProducto + "/",
data: dataString,
cache: false,
...
<hr>
<h1>
Agregar Items a la orden de Compra</h1>
<?php
...
{
 $claseEstilo = "error_box";
   $mensaje = "La compra seleccionada ya ha sido procesada.";
}
...
?>
<form action = "<?php echo base_url();?>micontrolador/AgregarProductosAlCarro/<?php echo $idCompra."/".$filasEncontradas["id"]."/";?>" METHOD = POST>
...
<tr>
   ...
   <td><input teype ="text" value ="<?php echo $filasEncontradas["cantidad"];?>" size ="9" name ="cantidad" id ="cantidad"></td>
   <!--td></td-->
   <td><input type ="text" value="<?php echo $filasEncontradas["costo"];?>" name ="costo" size = "9"></td>
   <td><?php 
   ...
   <td align ="center">
    <a href = "<?php echo base_url();?>micontrolador/EliminarLineaProductoCarro/<?php echo $filasEncontradas["id"]."/".$this->uri->segment(3,0)."/";?>">
  ...
  ?>
	...
	<tr>
		<td align = center colspan ="3"  rowspan="4"> 
           ...
           <a href="<?php echo base_url();?>micontrolador/EliminarProductosDelCarro/<?php echo $this->uri->segment(3,0)."/";?>"><img src="<?php echo base_url();?>images/error.png" border="0" title="Quitar todos" align = middle width = "25"></a>
       </td>
	...
	<tr>
		...
		<td colspan = "6" align = "right">
			<!--pra mostrar la busqueda intereactiva-->
				...
				<span class = interacitvo>Escriba el nombre o codigo del producto/servicio:</span><input type="text" class="buscar" id="cajabusqueda" name = "cajabusqueda" />
...
<form action ="<?php echo base_url();?>micontrolador/RegistrarDetalleCompra/" method = "POST" name = "cuentabancos" id = "cuentabancos">

   <li>
                      <label class="desc">Cuenta Contable:<span class="req">*</span></label>
                      <div>
                          <input name="cuentacontable" type="text" class="field text small" id="cuentacontable" value="" maxlength="255" readOnly />
						  <input name="nombrecuentacontable" type="text" class="field text small" id="nombrecuentacontable" value="" maxlength="255" readOnly />
                          ...
                          <input name="idcuentacontable" type="hidden" class="field text small" id="idcuentacontable" value="" maxlength="255" readOnly />

                      </div>
                  </li>
	<input type = "hidden" name ="totalsiniva" id="totalsiniva"  value ="<?php echo $totalNeto;?>">
	<input name="idcompra" type="hidden" value ="<?php echo $this->uri->segment(3,0);?>"  class="field text small" id="idcompra" value="" maxlength="255" readOnly />
	<br>
	<br>
	...
	<br>
  <input type = submit name=boton value ="Solicitar compra" class =css3button2>
</form>
</fieldset>
<?php
}
