...
<legend class = legend1>Nuevo Cheque CxP</legend>

        <form method="POST" id="cuentabancos" class="wufoo" action="<?php echo base_url();?>micontrolador/RegistrarChequeCxPSinUso/" name = "cuentabancos">
		<li>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <td>
           ...
           <li>
            ...
            <label class="desc">A nombre de:<span class="req">*</span></label>
                    <div>
                        <input name="anombrede" type="text" size = 60  id="anombrede" value="<?php echo $listarDatosChequeAmodificar[0]->a_nombre_de;?>" maxlength="255" readonly />
                    </div>
            </li>
      ...
      <tr>
         <td  width =15%>
                      ...
                      <div>
                          <input name="monto" type="text" class="field text medium" id="nomto" value="<?php echo $listarDatosChequeAmodificar[0]->monto_cheque;?>" readOnly maxlength="255"/>
                      </div>
                  </li>
          </td> 
           <td>
               <li> 
                    ...
                    <div>
                      ...
                      <input name="caja" type="text" class="field text medium" value = "E- Egreso" id="caja" value="" readOnly maxlength="255"/>
                       <input name="tipopartida" type="hidden" class="field text medium" value = "1" id="tipopartida" value="" readOnly maxlength="255"/>
        ...
        <td colspan = 2>
                    ...
                    <div>
                          <textarea class="catalogo"  rows="5" cols="60" name = "concepto" id = "concepto">
                          <?php echo $listarDatosChequeAmodificar[0]->concepto_cheque;?>
                          </textarea>
                    </div>
                </li>
				    </td>
