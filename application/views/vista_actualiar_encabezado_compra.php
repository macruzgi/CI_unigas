        ...
        $("#cuentabancos").RSV({
            ...
            rules: [
                ...
                //"required,codigo, Debe ingesar el código del proveedor.",
						...
						"required,idcomprobante,Debe haber seleccionado una compra."               
            ]
        });
    });
    //no se esta ocupando
...
<hr>
<h1>Modificar Encabezado de Compra</h1>
<?php
...
<legend class = legend1>Modificar Encabezado de Compra</legend>

        <form method="POST" id="cuentabancos" class="wufoo" action="<?php echo base_url();?>micontrolador/ActualizarEncabezadoOrdenCompra/" name = "cuentabancos">
		
     
	<?php
		foreach($listarCondicionesDePago as $formasPagosEcontrados):
		
		if($formasPagosEcontrados->dias == $listarEncabezadoOrdenCompraModificar[0]->dias_credito)
			{
				$idCondicionPago = $formasPagosEcontrados->id;
			}
		endforeach;
		if($listarEncabezadoOrdenCompraModificar[0]->tamanocontribuyente == NULL || $listarEncabezadoOrdenCompraModificar[0]->tamanocontribuyente == "")
			{
				$tamannoContri	= "W";//W ES NADA
			}
		else
			{
				$tamannoContri	= $listarEncabezadoOrdenCompraModificar[0]->tamanocontribuyente;
			}
			
	?>
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
	  <!--campos hidden-->
	  <input name="idcondicionpago" type="hidden"    id="idcondicionpago"  maxlength="255" value = "<?php echo $idCondicionPago;?>" readOnly /><!--id de la condiciones de pago-->
	  <input name="formapago" type="hidden"    id="formapago"  maxlength="255"value = "<?php echo $listarEncabezadoOrdenCompraModificar[0]->id_forma_pago;?>"  readOnly /><!--letra de la forma de pago-->
	  <input name="diascredito" type="hidden"    id="diascredito"  maxlength="255" value = "<?php echo $listarEncabezadoOrdenCompraModificar[0]->dias_credito;?>" readOnly /><!--numero de dias credito-->
	  <input name="tamannocontribuyente" type="hidden"    id="tamannocontribuyente"  maxlength="255" value = "<?php echo $tamannoContri;?>" readOnly />
	  <input name="idcomprobante" type="hidden"    id="idcomprobante"  maxlength="255" value = "<?php echo $listarEncabezadoOrdenCompraModificar[0]->id_comprobante;?>" readOnly />
<!--letra del tamaño del cotribuyente-->
	<!--fin campso hidden-->	
		<ul>
		<tr>
			<td>
				<li>
                    ...
                    <div>
					  ...
					  <option value = "<?php echo $listarEncabezadoOrdenCompraModificar[0]->id;?>"><?php echo   $listarEncabezadoOrdenCompraModificar[0]->codigo." - ".$listarEncabezadoOrdenCompraModificar[0]->descripcion;?></option>
                      <?php
			...
			<td>
				...
				<div>
                      <select name = "tipocomprobante" id="tipocomprobante">
						<?php 
							if($listarEncabezadoOrdenCompraModificar[0]->id_tipo_comprobante == 1)
								{
									$tipo 	  = 1;
									$concepto = "Comprobante de Cr&eacute;dito Fiscal"; 
								}
							elseif($listarEncabezadoOrdenCompraModificar[0]->id_tipo_comprobante == 3)
								{
									$tipo 	  = 3;
									$concepto = "Nota de D&eacute;bito"; 
								}
							elseif($listarEncabezadoOrdenCompraModificar[0]->id_tipo_comprobante == 4)
								{
									$tipo 	  = 4;
									$concepto = "Factura"; 
								}
							elseif($listarEncabezadoOrdenCompraModificar[0]->id_tipo_comprobante == 5)
								{
									$tipo 	  = 5;
									$concepto = "Recibo"; 
								}
						?>
						<option value = "<?php echo $tipo;?>"><?php echo $concepto;?></option>
      ...
      <tr>
        <td>
           ...
           <li>
            <label class="desc">Codigo proveedor:</label>    
                    <div>
                        <input name="codigo" type="text" class="field text medium" id="codigo" value="<?php echo $listarEncabezadoOrdenCompraModificar[0]->codigo_proveedor;?>" maxlength="255" readonly />
                        <input name="idproveedor" type="hidden" class="field text medium" id="idproveedor" value="<?php echo $listarEncabezadoOrdenCompraModificar[0]->id_proveedor;?>" maxlength="255"/> <!--este ide se lo mando cuendo voi a buscar las cuentas por pagar al proveedor-->
		...
		<td>
            ...
            <label class="desc">Nombre<span class="req">*</span></label>
                    <div>
                        <input name="nombreprove" type="text" class="field text large"   id="nombreprove" value="<?php echo $listarEncabezadoOrdenCompraModificar[0]->nombre;?>" maxlength="255" />
                    </div>
            </li>
	...
	<tr>
		<td width = "35%">
            ...
            <label class="desc">NIT<span class="req">*</span></label>
                    <div>
                        <input name="nit" type="text" class="field text large"  id="nit" value="<?php echo $listarEncabezadoOrdenCompraModificar[0]->nit;?>" maxlength="255" />
                    </div>
            </li>
		</td>
	   <td>
            ...
            <label class="desc">NRC<span class="req">*</span></label>
                    <div>
                        <input name="nrc" type="text" class="field text large"   id="nrc" value="<?php echo $listarEncabezadoOrdenCompraModificar[0]->nrc;?>" maxlength="255" />
                    </div>
            </li>
		</td>
	</tr>
      ...
      <tr>
		 <td>
		    <li>
						<?php
							if($listarEncabezadoOrdenCompraModificar[0]->dias_credito != 0)
								{
									$condicionPago = "CREDITO ".$listarEncabezadoOrdenCompraModificar[0]->dias_credito." DIAS";
								}
							ELSE
								{
									$condicionPago = "CONTADO ".$listarEncabezadoOrdenCompraModificar[0]->dias_credito." DIAS";
								}
						?>
						 <label class="desc">Condiciones de Pago Predeterminda:<span class="req">*</span></label>
						<input name="condicionpago" type="text" class="field text large"   id="condicionpago" value="<?php echo $condicionPago;?>" maxlength="255" readOnly />
                    </div>
            </li>
		  </td>
		  <td width ="30%">
         ...
         <!--td  width ="30%">
          ...
          <td>
                    ...
                    <div>
                     <input name="fecha" type="text" size =10  id="fecha" value = <?php echo $listarEncabezadoOrdenCompraModificar[0]->fecha?> maxlength="255"/>
                    </div> 
          </TD>
		    <td>
				    <li>
                    ...
                    <div>
                     <input name="solicitadapor" type="text" size ="25"  id="solicitadapor" value ="<?php echo $listarEncabezadoOrdenCompraModificar[0]->solicitada_por;?>" maxlength="255"/>
                    </div> 
          </TD>
        ...
        <td colspan = 2 align= center>
           ...
           <div align = center> 
                  ...
                  <input type="submit" name="" class="css3button2" value = "Actualizar">
                  <button type="button" name="" value="" class="css3button" onClick="location.replace('<?php echo base_url();?>micontrolador/VistaCompras/');">Cancelar</button>
          </div>
        </form>
