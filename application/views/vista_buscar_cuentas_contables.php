...
<a href ="<?php echo base_url();?>micontrolador/VistaReportes/">Reportes</a>
  ...
  <br>
<br>  
<a href="<?php echo base_url();?>micontrolador/VistaCrearPartidaDetalles/<?php echo $this->uri->segment(3,0)."/".$this->uri->segment(4,0)."/";?>">Volver</a>
...
?>
  <td><?php echo $cuentasContablesEncontradas->id;?></td>
   ...
   <td>
    <a href = "<?php echo base_url();?>micontrolador/AgregarCuentasAlaPartida/<?php  echo $cuentasContablesEncontradas->codigo;?>/<?php echo $idPartida  = $this->uri->segment(3,0)."/".$this->uri->segment(4,0);?>">
      Seleccionar
    </a>
