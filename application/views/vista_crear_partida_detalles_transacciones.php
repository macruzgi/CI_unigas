...
@session_start();
			if(isset($_SESSION["cuentasAlaPartidaTransaccion"]) || is_array($_SESSION["cuentasAlaPartidaTransaccion"])) {
			   $cuentasAlaPartidaTransaccion= $_SESSION["cuentasAlaPartidaTransaccion"];
							}
...
var idTransaccion = document.getElementById("idtransaccion").value;
...
$.ajax({
type: "POST",
url: "<?php echo base_url();?>micontrolador/InteractivoPartidaTransaccion/" + idPartida + "/" + idTransaccion,
data: dataString,
cache: false,
...
<tr>
<?php
foreach($listarPartidaNoProcesadaTransaccion as $partidaEncontrada):
?>
...
$sumaCargos = 0;
$sumaAbonos = 0;
foreach($cuentasAlaPartidaTransaccion as $cuentaAlaPartidaEncontradas){ 
...
?>
<form action = "<?php echo base_url();?>micontrolador/AgregarCuentasAlaPartidaTransacciones/<?php echo $cuentaAlaPartidaEncontradas["codigo"];//eso para que uando le de enter se vala el código del producto correspondiente a cada caja de texto?>/<?php echo $idPartida = $this->uri->segment(3,0)."/".$this->uri->segment(4,0);?>" METHOD = POST>
 <tr> 
 ...
 <input type = hidden value="<?php echo $primerDetalleEncontrado->concepto;?>" name = conceptoOriginal> <!--est campo es para enviar el concepto original y ponerlo en la demas textbos si no se pone concepto-->
   ...
   <td width = "12%">
    ...
    &nbsp;&nbsp;
    <a href = "<?php echo base_url();?>micontrolador/EliminarLineaDetallesPartidasTransaccion/<?php  echo $cuentaAlaPartidaEncontradas["codigo"];?>/<?php echo $idPartida = $this->uri->segment(3,0)."/".$this->uri->segment(4,0);?>/">
...
<tfoot>
  <tr>
    ...
    <td colspan="3" align = center>
              ...
              <a href="<?php echo base_url();?>micontrolador/EliminarDetallesPartidasTransaccion/<?php echo $idPartida = $this->uri->segment(3,0)."/".$this->uri->segment(4,0);?>"><img src="<?php echo base_url();?>images/error.png" border="0" title="Eliminar Detalles" align = middle></a>
       
     

              <a href ="<?php echo base_url();?>micontrolador/VistaBuscarCuentasContablesTransaciones/<?php echo $idPartida  = $this->uri->segment(3,0)."/".$this->uri->segment(4,0);?>"> <img src = "<?php echo base_url();?>images/buscar.png" title = "Buscar Cuenta" align = middle></a>
     </td>
     <td colspan="3" align = right>
            <font color = black>Cargos:$ <?php echo $totalCargos;?>
            Abonos:$ <?php echo $totalAbonos;?></font></font>
...
<input type="hidden"  id="idtransaccion" value="<?php echo $this->uri->segment(4,0);?>" /><br /><br />
...
<form action ="<?php echo base_url();?>micontrolador/GuardarYcontabilizarTransaccion/<?php echo $idPartida = $this->uri->segment(3,0)."/".$this->uri->segment(4,0);?>/" method = "POST">
